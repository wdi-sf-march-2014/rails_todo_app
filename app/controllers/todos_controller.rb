class TodosController < ApplicationController
  ...
  def recent
    # BEST PRACTICE: Do not put the logic in the controller when
    #                it can be put in the model.  The following commented
    #                out code has too much logic in the controller.
    # @todos = Todo.all.select {|row| row.updated_at > Date.today }

    # Prefered way of getting recent todos:
